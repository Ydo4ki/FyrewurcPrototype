...
public final class JShortFw {
    public static final Type jshort = WrapperTypeFw.wrapperType(PrimitiveLayoutsFw.word, FW.lambda_native(instance -> FW.lambda_native(rawPayload -> FW.lambda_native(arg -> {
