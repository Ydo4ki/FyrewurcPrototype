...
public final class Unspecified {
                ...
                case "val":
                    return FW.lambda_native(unspecified -> {
                        if (isUnspecified(unspecified))
                            return ((UnspecifiedRecord) unspecified._UNPACK_()).val();
                        return null;
                    });
                case "arg":
                    return FW.lambda_native(unspecified -> {
                        if (isUnspecified(unspecified))
                            return ((UnspecifiedRecord) unspecified._UNPACK_()).arg();
                        return null;
                    });
            }
        }
    ...
    public static Value getVal(Val val) {
        return ((UnspecifiedRecord) val._UNPACK_()).val;
    }

    public static Value getArg(Val val) {
        return ((UnspecifiedRecord) val._UNPACK_()).arg;
    }
