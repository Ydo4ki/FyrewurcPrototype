...
public final class DirectCompEnv {
    ...
    public static Vit compile(Expr expr, Function<String, Val> get) throws ExprVitCompilationException {
        if (expr instanceof Symbol) {
            ...
            if (list.getBracketsType().equals(BracketsTypes.braces) && list.size() == 2) {
                ...
                if (!(name instanceof Symbol))
                    throw new ExprVitCompilationException(name, "Symbol exprected");
