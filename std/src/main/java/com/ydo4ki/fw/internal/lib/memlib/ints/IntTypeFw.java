...
public final class IntTypeFw {
    ...
    public static final Type int_t = FW.lambda_native(arg -> {
        if (FwUtils.isTypeApiCall(arg, IntTypeFw.int_t)) {
            ...
            if (FwUtils.isTypeApiCall(arg, Int)) {
                Val int_instance = (Val) CallFw.getVal(arg);
                arg = (Val) CallFw.getArg(arg);
                ...
                switch (s) {
                    ...
                    case "construct":
                        return FW.lambda_native(arg1 -> {
                            ...
                            Val val = ((Val) Int.get("bitwidth"));
                            int bitwidth = val._UNPACK_(Number.class).intValue();
...
//        }
//        if (arg.getType() == int_t) {
//            return ExprFw.wrap(ExprList.of(BracketsTypes.round,
//                    arg.getType().asVal().toExpr_Old(toExpr),
