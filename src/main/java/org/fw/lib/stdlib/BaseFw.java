        ...
        if (arg.getType().equals(SyntaxResolveFw.syntaxResolve)) {
            ...
            if (expr instanceof ExprList && ((ExprList) expr).getBracketsType().equals(BracketsTypes.round) && ((ExprList) expr).size() > 0) {
                ...
                if (f instanceof Symbol) if (((Symbol) f).getValue().equals("typeof")) {
                    ...
                    return VitFw.wrap(Vit.call(TypeGetFw.typeGet, operand._UNPACK_(Vit.class)));
                    ...
                    return VitFw.wrap(Vit.call(Unspecified.isUnspecified, operand._UNPACK_(Vit.class)).call(symbol("not")));
                }
            }
        }
        return null;
