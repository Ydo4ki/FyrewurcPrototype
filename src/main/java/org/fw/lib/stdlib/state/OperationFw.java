            ...
            if (expr instanceof ExprList && ((ExprList) expr).getBracketsType().equals(BracketsTypes.round) && ((ExprList) expr).size() > 0) {
                ...
                if (f instanceof Symbol) switch (((Symbol) f).getValue()) {
                    case "operation": {
                        ...
                        Val val = compEnv.call(CompEnv.syntaxResolve(exprVal.call(DIntFw.dint(1))._UNPACK_(Expr.class), CompEnv.of(compEnv)));
                    ...
                    case "while": {
                        ...
                        if (!VitFw.isVit(condition.getType()))
                            return condition;
                        Val body = compEnv.call(CompEnv.syntaxResolve(exprVal.call(DIntFw.dint(2))._UNPACK_(Expr.class), CompEnv.of(compEnv)));
                    ...
                    case "if": {
                        ...
                        Val condition = compEnv.call(CompEnv.syntaxResolve(exprVal.call(DIntFw.dint(1))._UNPACK_(Expr.class), CompEnv.of(compEnv)));
                        Val ifTrue = compEnv.call(CompEnv.syntaxResolve(exprVal.call(DIntFw.dint(2))._UNPACK_(Expr.class), CompEnv.of(compEnv)));
                        Expr ELSE = exprVal.call(DIntFw.dint(3))._UNPACK_(Expr.class);
                        if (!ELSE.toString().equals("else"))
                            return null;

                        Val ifFalse = compEnv.call(CompEnv.syntaxResolve(exprVal.call(DIntFw.dint(4))._UNPACK_(Expr.class), CompEnv.of(compEnv)));
