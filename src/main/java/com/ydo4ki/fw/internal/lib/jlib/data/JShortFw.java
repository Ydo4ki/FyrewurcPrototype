...
public final class JShortFw {
    public static final Type jshort = WrapperTypeFw.wrapperType(PrimitiveLayoutsFw.word, FW.telephonist_native_standalone(instance -> FW.telephonist_native_standalone(rawPayload -> FW.telephonist_native_standalone(arg -> {
    ...
    public static Val wrap(Short b) {
        return Val._NEW_INSTANCE_(jshort, b);
    }
